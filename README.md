...
1. Accessed [vSphere]() and selected the correct sandbox correlated to the Host IP: 10.1.XX.XX
        
    <img src="Insert Redacted Image/>
...
2. Opened vSphere Client and highlighted Data Center 10.1.XX.XX
